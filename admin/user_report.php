            ...
            <div class="padding-md">
                <div class="search-filter">
                    ...
                    <center ><h4>Report From user</h4></center>
                        <li><a tabindex="-1" class=" logoutConfirm_open pull-right" href="../logout.php"><i class="fa fa-lock fa-lg"></i> Log out</a></li>
...
// die();
                      ...
                      echo'  
                        ...
                        <form  method="post">
                                    ...
                                    <button  type="submit"  name="Submit1" class="btn btn-success"><i class="fa fa-check fa-lg"></i> <a href="user_report.php?id3='. $id.'">Approve</a></button>
 ...
 if (isset($_GET['id3'])) {
    $id4=$_GET['id3'];
     ...
     $profile_pic_query=mysql_query("UPDATE `report` SET open='1' where id='$id4'");

 echo "<script>alert('Report  approve');</script>";
    echo "<script>window.location='../admin/user_report.php';</script>";
