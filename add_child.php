...
move_uploaded_file($_FILES['image']['tmp_name'],'./images/'.$_FILES['image']['name']);
    ...
    $gallery=mysql_query("INSERT INTO `test`(`name`, `last_name`, `parent`, `birthday`, `photo` , `citizenship_number`) VALUES ('$name', '$ln','$id','$date','".$_FILES['image']['name']."','$citizenship_number')");

 // $profile_pic_query=mysql_query("INSERT INTO `test`(`id`, `name`, `child`, `parent`, `position`, `birthday`, `geant_parent`, `photo`, `citizenship_number`) VALUES ([],[$name],[],[$id],[],[$date],[],[],[$citizenship_number])");


    if($gallery){
  
  echo "<script>window.location='d.php?child_id=$id';</script>";
      // echo "ok";
...
?>
        ...
        <div class="padding-md">
            ...
            <h3 class="headline" style="text:centre">
							<center>To Add your Child fill the following form</center>
						</h3>
                         <div class="col-md-4">
                         <!--  <h4 class="headline">
              ...
              <div class="col-md-4">
                   <center>    <div class="panel panel-default">
                            ...
                            <div class="panel-heading">Fill with Detail information About your Child</div>
          ...
          <span class='sr-only'>Error:</span>".$message."
                            ...
                            <div class="panel-body">
                               ...
                               <!--   <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Child Full Name</label>
                                  ...
                                  <input type="text" name='date'class="form-control" id="exampleInputDOB1" placeholder="Eg.  2052-02-11">
                                   ...
                                   <div class="form-group">
                                        <label for="exampleInputEmail1">Child Citizenship number</label>
